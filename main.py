...
# =======================================================
    ...
    parser.add_argument("--exp_tag", type=str, default="SRDenseNet tensorflow. Implemented by Dohyun Kim")
    ...
    parser.add_argument("--num_denseblock", type=int, default= 8) #paper setup
    parser.add_argument("--num_denselayer", type=int, default = 8)
